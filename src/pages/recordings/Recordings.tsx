        ...
        {loading ? (
          ...
          <>
            <div className="flex justify-end mb-4">
              <button
                className="bg-white dark:bg-slate-700 text-slate-600 dark:text-slate-300 border border-slate-300 dark:border-slate-600 px-4 py-2 text-sm font-medium rounded cursor-pointer transition-colors hover:bg-slate-100 dark:hover:bg-slate-600"
            ...
            <div className="flex flex-col gap-3">
              {recordings.map((recording) => (
                ...
                >
                  ...
                  <button
                    className="bg-transparent border border-slate-300 dark:border-slate-600 px-3 py-2 text-lg rounded cursor-pointer transition-all flex-shrink-0 hover:bg-red-600 dark:hover:bg-red-500 hover:border-red-600 dark:hover:border-red-500"
